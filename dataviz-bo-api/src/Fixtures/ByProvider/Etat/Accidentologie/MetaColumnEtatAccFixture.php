...
class MetaColumnEtatAccFixture extends AbstractMetaColumnFixture
{
    ...
    {
        yield ['etat.acc_caracteristique', 'num_acc', 'Numéro d\'identifiant de l\'accident', false, DataTypeEnum::CHARACTER_VARYING->value, 12];
        yield ['etat.acc_caracteristique', 'date', 'Date de l\'accident', false, DataTypeEnum::TIME_WNTZ->value, null];
        ...
        yield ['etat.acc_caracteristique', 'lat', 'Latitude', true, DataTypeEnum::NUMERIC->value, null];
        yield ['etat.acc_caracteristique', 'lng', 'Longitude', true, DataTypeEnum::NUMERIC->value, null];

        yield ['etat.acc_lieu', 'num_acc', 'Numéro d\'identifiant de l\'accident', false, DataTypeEnum::CHARACTER_VARYING->value, null];
        ...
        yield ['etat.acc_lieu', 'nbv', 'Nombre total de voies de circulation', true, DataTypeEnum::INTEGER->value, null];
        ...
        yield ['etat.acc_lieu', 'vma', 'Vitesse maximale autorisée sur le lieu et au moment de l\'accident', true, DataTypeEnum::INTEGER->value, null];

        yield ['etat.acc_vehicule', 'num_acc', 'Numéro d\'identifiant de l\'accident', false, DataTypeEnum::CHARACTER_VARYING->value, null];
        ...
        yield ['etat.acc_vehicule', 'occutc', 'Nombre d\'occupants dans le transport en commun', true, DataTypeEnum::INTEGER->value, null];

        yield ['etat.acc_usager', 'num_acc', 'Numéro d\'identifiant de l\'accident', false, DataTypeEnum::CHARACTER_VARYING->value, null];
        ...
        yield ['etat.acc_usager', 'an_nais', 'Année de naissance de l\'usager', true, DataTypeEnum::INTEGER->value, null];
