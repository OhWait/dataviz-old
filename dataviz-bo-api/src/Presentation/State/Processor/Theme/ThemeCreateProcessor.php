...
use App\Application\Command\Theme\CreateThemeCommand;
 ...
 */
final class ThemeCreateProcessor extends AbstractProcessor
{
    ...
    private function createCommand(ThemeResource $data): Theme
    {
        $message = new CreateThemeCommand(
