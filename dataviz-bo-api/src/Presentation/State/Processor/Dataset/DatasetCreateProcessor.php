...
use App\Application\Command\Dataset\CreateDatasetCommand;
 ...
 */
final class DatasetCreateProcessor extends AbstractProcessor
{
    ...
    public function process(
        ...
        try {
            $dataset = $this->createCommand($data);
    ...
    private function createCommand(DatasetResource $data): Dataset
    {
