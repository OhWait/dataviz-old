 ...
 */
final class Version20250215105244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE data_entry (created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, schema_name VARCHAR(255) NOT NULL, table_name VARCHAR(255) NOT NULL, dataset_id VARCHAR(255) NOT NULL, PRIMARY KEY(slug))');
        ...
        $this->addSql('CREATE TABLE dataset (created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, short_title VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, perimeter TEXT NOT NULL, granularity VARCHAR(255) NOT NULL, update_frequency VARCHAR(255) DEFAULT NULL, update_period VARCHAR(255) DEFAULT NULL, security VARCHAR(255) NOT NULL, language VARCHAR(255) DEFAULT NULL, data_created_at DATE DEFAULT NULL, data_updated_at DATE DEFAULT NULL, data_provider VARCHAR(255) DEFAULT NULL, provider_id VARCHAR(255) NOT NULL, PRIMARY KEY(slug))');
        ...
        $this->addSql('CREATE TABLE meta_column (id UUID NOT NULL, column_name VARCHAR(255) NOT NULL, nullable BOOLEAN NOT NULL, data_type VARCHAR(255) NOT NULL, character_maximum_length INT DEFAULT NULL, label VARCHAR(255) DEFAULT NULL, data_entry_id VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6F0B289870E8809E ON meta_column (data_entry_id)');
        $this->addSql('CREATE TABLE meta_row (id UUID NOT NULL, value VARCHAR(255) NOT NULL, label VARCHAR(255) DEFAULT NULL, meta_column_id UUID NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2BBC28565FCE5B35 ON meta_row (meta_column_id)');
        $this->addSql('CREATE TABLE provider (image VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, acronym VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(slug))');
        ...
        $this->addSql('ALTER TABLE theme_dataset ADD CONSTRAINT FK_EEC344F3B7A041D0 FOREIGN KEY (dataset) REFERENCES dataset (slug) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE theme_dataset ADD CONSTRAINT FK_EEC344F39775E708 FOREIGN KEY (theme) REFERENCES theme (slug) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
